         ...
         <main className="flex min-h-screen lg:flex-row  gap-5 flex-col py-[100px] pt-[160px] items-center font-poppins justify-around px-10 pb-4">
            ...
            >
               ...
               <p className="text-sm text-slate-500 font-light">
                  ...
                  I'm a dedicated Frontend Developer driven by a passion for crafting impactful solutions. With expertise in JavaScript and TypeScript, I specialize in React.js, Vue.js, Next.js, and  React-Native, I'm also familiar with other JavaScript frameworks and libraries as well. My focus on innovation and value delivery ensures seamless user experiences and positive outcomes for businesses and communities."
               </p>
               <p className="text-sm text-slate-500 font-light">
               ...
               <div className="flex gap-5 items-center">
                  <Link
                     ...
                     href=" https://drive.google.com/file/d/12D7Q0Gg-1bXiicnyuIsc2gBn7X_HGkZw/view?usp=sharing"
                  >
                    Download CV
                  </Link>
               </div>
